    ...
    <div className="space-y-6">
      ...
      {!loading && !error && report && (
        <div className="space-y-6">
          ...
          <div
            className={`rounded-2xl border p-5 sm:p-6 shadow-sm transition ${predStyle.heroBg}`}
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/60 pb-5 mb-5">
              <div>
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  <span className="text-2xl sm:text-3xl font-black text-[#0F1F5C] tracking-tight">
              ...
              <div className="sm:text-right bg-white/80 rounded-xl p-4 border border-slate-200/70">
                <span className="text-[11px] text-slate-500 font-semibold uppercase tracking-wider">Model Confidence</span>
                <p className="text-xl sm:text-2xl font-extrabold text-[#0F1F5C] mt-0.5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5 text-xs">
              ...
              <div className="rounded-xl bg-white/80 p-3.5 border border-slate-200/60">
                ...
                <Link
                  to={`/health-worker/screenings/${report.screening_id}`}
                  className="font-bold text-[#3F54DA] hover:underline mt-1 block font-mono"
                >
                  #{report.screening_id}
                </Link>
              </div>
              ...
              <div className="rounded-xl bg-white/80 p-3.5 border border-slate-200/60">
                ...
                <span className="font-bold text-[#0F1F5C] mt-1 block font-mono">
                  #{report.id}
                </span>
              </div>
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <span
                          className={`font-semibold ${
                            isMax ? "text-[#0F1F5C] font-bold" : "text-slate-700"
                          }`}
                        >
                          {stage}
                          {isMax && (
                      ...
                      <div className="h-2.5 w-full overflow-hidden rounded-full bg-slate-100">
                        <div
                          className={`h-full rounded-full transition-all duration-500 ${
                            isMax ? predStyle.barColor : "bg-slate-300"
                          }`}
                          style={{ width: `${pctVal}%` }}
                        ></div>
                      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <>
                      ...
                      {origImageError && (
                        <div className="p-4 text-center text-slate-400 text-xs">
                          <p className="text-rose-400">Unable to load original fundus image.</p>
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-[#3F54DA] font-semibold">
                    Neural Focus
                  </span>
                </div>
                ...
                <div className="relative aspect-square w-full rounded-lg bg-slate-900 flex items-center justify-center overflow-hidden">
                  {report.gradcam_url ? (
                    <>
                      ...
                      {gradcamImageError && (
                        <div className="p-4 text-center text-slate-400 text-xs">
                          <p className="text-rose-400">Unable to load Grad-CAM overlay image.</p>
                          <p className="text-[10px] mt-1 text-slate-500 break-all font-mono">
                            {report.gradcam_url}
                          </p>
                        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-5 sm:p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-4">
                  <div className="rounded-xl bg-slate-50 p-4 border border-slate-100">
                    ...
                    <p className="mt-1 text-base font-bold text-[#0F1F5C]">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {getFeaturesList().map((feature, idx) => (
                        ...
                        >
                          <span className="text-[#3F54DA] font-bold">•</span>
              ...
              {/* Print / Actions */}
              <div className="pt-5 border-t border-slate-100 mt-6 flex items-center justify-between gap-3">
                <button
                  type="button"
